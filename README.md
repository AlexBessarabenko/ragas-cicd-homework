...
| **Answer Relevance** | Оценивает, насколько ответ релевантен вопросу | ≥ 0.6 |
...
### Answer Relevance
- **≥ 0.8**: Ответ точно отвечает на вопрос
- **0.6–0.8**: Ответ частично релевантен
- **< 0.6**: Ответ не отвечает на вопрос
